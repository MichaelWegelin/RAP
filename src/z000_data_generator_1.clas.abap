CLASS z000_data_generator_1 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS z000_data_generator_1 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DELETE FROM z000_travel.                          "#EC CI_NOWHERE
    INSERT z000_travel FROM TABLE @lt_travel_m.
    ...
    DELETE FROM z000_booking.
    INSERT z000_booking FROM TABLE @lt_booking_m.
